...
select the "Graphical Automated Install..." option. Inside this menu,
highlight the "Automated Install" option but do NOT press ENTER.
...
After editing the line press "F10" to start the installation process.
